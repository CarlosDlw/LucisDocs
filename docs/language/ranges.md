...
This page covers range expressions in Lucis — the `..` and `..=` operators used in loops and list comprehensions.

## Overview

Ranges represent a sequence of integer values between a start and end. Lucis has two range operators:
