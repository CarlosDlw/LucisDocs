---
id: language_expressions
title: "Expressions"
sidebar_position: 8
---
# Expressions

Expressions in Lucis produce values. They can be combined, nested, and used anywhere a value is expected — in assignments, function arguments, return statements, conditions, and more.
