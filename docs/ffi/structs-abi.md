...
Once you have a C struct in Lucis, you access fields with dot notation, just like Lucis structs:
...
- [Structs](../language/structs.md) — Lucis struct declarations and methods
